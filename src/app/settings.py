...
MIDDLEWARE = [
    ...
    'app.middlewares.RequestFileLoggingMiddleware'
]
...
EMAIL_HOST_USER_NAME = config('EMAIL_HOST_USER_NAME', default='')
...
MAILBOXLAYER_API_KEY = config('MAILBOXLAYER_API_KEY', default='')
...
SENDGRID_VERIFY_EMAIL_TEMPLATE_ID = config('SENDGRID_VERIFY_EMAIL_TEMPLATE_ID', default='')
